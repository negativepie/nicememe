...
//integers representing different game modes, this ensures the programmer can refer to these modes by memorisable names rather than arbitrary integers. 
int mode;
final int INTRO=1;
final int PLAY=2;
...
//This draws the picture of the intro screen. 
