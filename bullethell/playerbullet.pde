//player bullet class, parameters give x,y coords and velocities, behavior dictates the pattern which in this case is straight. The starting coords are determined by the player's hitbox circle. 
